...
const EditProjectPriority = () => {
  ...
  const fetchSingleData = async (id) => {
    try {
      const response = await axios.get(`${base_url}/api/v1/projectPriority/single-projectPriority/${id}`, {
        headers: {
  ...
  const handleUpdate = async (e, id) => {
    ...
    try {
      const response = await axios.put(`${base_url}/api/v1/projectPriority/update-projectPriority/${id}`, updateData, {
        headers: {
          Authorization: validToken,
        },
      });
