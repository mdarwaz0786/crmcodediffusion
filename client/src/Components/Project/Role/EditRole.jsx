...
const EditRole = () => {
  ...
  const [permissions, setPermissions] = useState({
    ...
    attendance: {
      ...
      fields: {
        ...
        service: { read: true, show: true },
        salarySlip: { read: true, show: true },
        leaveBalance: { read: true, show: true },
        writeWorkSummary: { read: true, show: true },
        applyLeave: { read: true, show: true },
        applyMissedPunchOut: { read: true, show: true },
        applyLatePunchIn: { read: true, show: true },
        applyCompOff: { read: true, show: true },
        project: { read: true, show: true },
        taxInvoice: { read: true, show: true },
        proformaInvoice: { read: true, show: true },
        ticket: { read: true, show: true },
        aboutUs: { read: true, show: true },
        contactUs: { read: true, show: true },
        helpAndSupport: { read: true, show: true },
        attendance: { read: true, show: true },
        workSummary: { read: true, show: true },
        approval: { read: true, show: true },
        message: { read: true, show: true },
        upcomingHoliday: { read: true, show: true },
      },
    },
    projectDeployment: {
      access: false,
    ...
    team: {
      ...
      fields: {
        ...
        role: { read: true, show: true },
        UAN: { read: true, show: true },
        PAN: { read: true, show: true },
        bankAccount: { read: true, show: true },
        office: { read: true, show: true },
        department: { read: true, show: true },
    ...
    addOnService: {
      ...
      fields: {
        ...
        projectName: { read: true, show: true },
        serviceName: { read: true, show: true },
        totalProjectCost: { read: true, show: true },
      },
    },
    service: {
      access: false,
    ...
    salary: {
      ...
      delete: false,
      fields: {
        transactionId: { read: true, show: true },
      },
    },
    missedPunchOut: {
      access: false,
    ...
    leaveApproval: {
      ...
      delete: false,
      fields: {
        leaveStatus: { read: true, show: true },
      },
    },
    compOff: {
      access: false,
    ...
    office: {
      ...
      delete: false,
      fields: {
        uniqueCode: { read: true, show: true },
        name: { read: true, show: true },
        websiteLink: { read: true, show: true },
        logo: { read: true, show: true },
        email: { read: true, show: true },
        noReplyEmail: { read: true, show: true },
        noReplyEmailAppPassword: { read: true, show: true },
        contact: { read: true, show: true },
        GSTNumber: { read: true, show: true },
        accountNumber: { read: true, show: true },
        accountName: { read: true, show: true },
        accountType: { read: true, show: true },
        bankName: { read: true, show: true },
        IFSCCode: { read: true, show: true },
        latitude: { read: true, show: true },
        longitude: { read: true, show: true },
        attendanceRadius: { read: true, show: true },
        addressLine1: { read: true, show: true },
        addressLine2: { read: true, show: true },
        addressLine3: { read: true, show: true },
      },
    },
    notification: {
      access: false,
  ...
  const permissionLabels = {
    ...
    service: "Service",
    salary: "Salary",
    missedPunchOut: "Missed Punch Out",
    latePunchIn: "Late Punch In",
    leaveApproval: "Leave Requesst",
    compOff: "Comp Off",
    office: "Office",
