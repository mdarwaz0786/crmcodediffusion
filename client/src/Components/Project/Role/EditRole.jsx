...
const EditRole = () => {
  ...
  const [permissions, setPermissions] = useState({
    ...
    ticket: {
      ...
      delete: false,
      fields: {
        ticketId: { read: true, show: true },
        title: { read: true, show: true },
        description: { read: true, show: true },
    ...
    team: {
      ...
      fields: {
        ...
        allotedLeaveBalance: { read: true, show: true },
        currentLeaveBalance: { read: true, show: true },
