...
const ProjectTiming = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (isdelete === "yes") {
      try {
        const response = await axios.delete(`${base_url}/api/v1/projectTiming/delete-projectTiming/${id}`, {
          headers: {
            Authorization: validToken,
          },
        });
            ...
            <div className="col-md-12">
              ...
              <div className="page-header">
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">Project Timlines<span className="count-title">{total}</span></h4>
                  </div>
                        ...
                        <div className="export-list text-sm-end">
                          <ul>
                                  ...
                                  <div className="export-dropdwon">
                                    ...
                                    <div className="dropdown-menu  dropdown-menu-end">
                                      <ul>
                                        ...
                                        <li>
                                          <Link to="#" onClick={() => setTimeout(() => { exportProjectTimingListAsExcel() }, 0)}>
                            ...
                            }
                            {
                              (permissions?.create) && (
                                <li>
                                  <Link to="/add-project-timeline" className="btn btn-primary">
                                ...
                                <div className="accordion" id="accordionExample">
                                  <div className="filter-set-content">
                                    <div className="filter-set-content-head">
                                      <Link to="#" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Project Timeline Name</Link>
                                    </div>
                                    <div className="filter-set-contents accordion-collapse collapse show" id="collapseTwo" data-bs-parent="#accordionExample">
                                      <div className="filter-content-list">
                                        <div className="form-wrap icon-form">
                                          <span className="form-icon"><i className="ti ti-search" /></span>
                                          <input type="text" className="form-control" placeholder="Search Project Timeline Name" onChange={(e) => setName(e.target.value)} />
                                        </div>
                                        <ul>
                                          {
                                            nameData?.map((n) => (
                              ...
                              <td>
                                <div className="table-action">
                                  ...
                                  <div className="dropdown-menu dropdown-menu-right">
                                    {
                                      (permissions?.update) && (
                                        <Link to={`/edit-project-timeline/${d?._id}`} className="dropdown-item">
