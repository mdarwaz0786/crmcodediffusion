...
const MissedPunchOut = () => {
  ...
  const handleUpdateLeaveStatus = async (e, leaveId) => {
    ...
    try {
      ...
      const response = await axios.put(`${base_url}/api/v1/missedPunchOut/update-missedPunchOut`,
            ...
            <div className="col-md-12">
              ...
              <div className="page-header">
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">Missed Punch Outs<span className="count-title">{total}</span></h4>
                  </div>
